...
#===================
        ...
        self.miniAtoHfinbtn.clicked.connect(self.minibotfinAtoHer)
        self.miniHtoSfinbtn.clicked.connect(self.minibotfinHtoSer)
        self.roboUfinbtn.clicked.connect(self.roboarmfinpicker)
        self.roboPfinbtn.clicked.connect(self.roboarmfinunleasher)
