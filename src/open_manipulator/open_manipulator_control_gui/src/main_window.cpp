...
void MainWindow::timerCallback()
{
  ...
  ui.txt_j4_2->setText(QString::number(joint_angle.at(4),'f', 3)); 
...
void MainWindow::on_btn_init_pose_clicked(void)
{
  ...
  joint_name.push_back("joint4_2"); joint_angle.push_back(0.0);
...
void MainWindow::on_btn_read_joint_angle_clicked(void)
{
  ...
  ui.doubleSpinBox_j4_2->setValue(joint_angle.at(4));
...
void MainWindow::on_btn_send_joint_angle_clicked(void)
{
  ...
  joint_name.push_back("joint4_2"); joint_angle.push_back(ui.doubleSpinBox_j4_2->value());
